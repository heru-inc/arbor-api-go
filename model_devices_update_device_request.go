...
type _DevicesUpdateDeviceRequest DevicesUpdateDeviceRequest
...
func (o *DevicesUpdateDeviceRequest) UnmarshalJSON(data []byte) (err error) {
	varDevicesUpdateDeviceRequest := _DevicesUpdateDeviceRequest{}

	err = json.Unmarshal(data, &varDevicesUpdateDeviceRequest)

	if err != nil {
		return err
	}

	*o = DevicesUpdateDeviceRequest(varDevicesUpdateDeviceRequest)
