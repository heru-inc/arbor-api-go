...
// checks if the GetDeviceGroups200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceGroups200ResponseMeta{}

// GetDeviceGroups200ResponseMeta struct for GetDeviceGroups200ResponseMeta
type GetDeviceGroups200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetDeviceGroups200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetDeviceGroups200ResponseMeta GetDeviceGroups200ResponseMeta
...
func NewGetDeviceGroups200ResponseMeta() *GetDeviceGroups200ResponseMeta {
	this := GetDeviceGroups200ResponseMeta{}
	return &this
}
...
func (o *GetDeviceGroups200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetDeviceGroups200ResponseMeta) GetLinks() []GetDeviceGroups200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetDeviceGroups200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetDeviceGroups200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetDeviceGroups200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetDeviceGroups200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceGroups200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetDeviceGroups200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetDeviceGroups200ResponseMeta := _GetDeviceGroups200ResponseMeta{}

	err = json.Unmarshal(data, &varGetDeviceGroups200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetDeviceGroups200ResponseMeta(varGetDeviceGroups200ResponseMeta)
...
type NullableGetDeviceGroups200ResponseMeta struct {
	value *GetDeviceGroups200ResponseMeta
	isSet bool
}

func (v NullableGetDeviceGroups200ResponseMeta) Get() *GetDeviceGroups200ResponseMeta {
	return v.value
}

func (v *NullableGetDeviceGroups200ResponseMeta) Set(val *GetDeviceGroups200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceGroups200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceGroups200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceGroups200ResponseMeta(val *GetDeviceGroups200ResponseMeta) *NullableGetDeviceGroups200ResponseMeta {
	return &NullableGetDeviceGroups200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetDeviceGroups200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceGroups200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
