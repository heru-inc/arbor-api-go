...
type _CompleteUploadAppVersionValidationErrorBodyErrors CompleteUploadAppVersionValidationErrorBodyErrors
...
func (o *CompleteUploadAppVersionValidationErrorBodyErrors) UnmarshalJSON(data []byte) (err error) {
	varCompleteUploadAppVersionValidationErrorBodyErrors := _CompleteUploadAppVersionValidationErrorBodyErrors{}

	err = json.Unmarshal(data, &varCompleteUploadAppVersionValidationErrorBodyErrors)

	if err != nil {
		return err
	}

	*o = CompleteUploadAppVersionValidationErrorBodyErrors(varCompleteUploadAppVersionValidationErrorBodyErrors)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "parts.0.partNumber")
		delete(additionalProperties, "parts.1.partNumber")
		delete(additionalProperties, "parts.0.eTag")
		delete(additionalProperties, "parts.1.eTag")
