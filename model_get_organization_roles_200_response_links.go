...
// checks if the GetOrganizationRoles200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganizationRoles200ResponseLinks{}

// GetOrganizationRoles200ResponseLinks struct for GetOrganizationRoles200ResponseLinks
type GetOrganizationRoles200ResponseLinks struct {
...
type _GetOrganizationRoles200ResponseLinks GetOrganizationRoles200ResponseLinks
...
func NewGetOrganizationRoles200ResponseLinks() *GetOrganizationRoles200ResponseLinks {
	this := GetOrganizationRoles200ResponseLinks{}
	return &this
}
...
func (o *GetOrganizationRoles200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetOrganizationRoles200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetOrganizationRoles200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetOrganizationRoles200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetOrganizationRoles200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetOrganizationRoles200ResponseLinks := _GetOrganizationRoles200ResponseLinks{}

	err = json.Unmarshal(data, &varGetOrganizationRoles200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetOrganizationRoles200ResponseLinks(varGetOrganizationRoles200ResponseLinks)
...
type NullableGetOrganizationRoles200ResponseLinks struct {
	value *GetOrganizationRoles200ResponseLinks
	isSet bool
}

func (v NullableGetOrganizationRoles200ResponseLinks) Get() *GetOrganizationRoles200ResponseLinks {
	return v.value
}

func (v *NullableGetOrganizationRoles200ResponseLinks) Set(val *GetOrganizationRoles200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationRoles200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationRoles200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationRoles200ResponseLinks(val *GetOrganizationRoles200ResponseLinks) *NullableGetOrganizationRoles200ResponseLinks {
	return &NullableGetOrganizationRoles200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetOrganizationRoles200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationRoles200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
