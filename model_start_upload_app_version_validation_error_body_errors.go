...
type _StartUploadAppVersionValidationErrorBodyErrors StartUploadAppVersionValidationErrorBodyErrors
...
func (o *StartUploadAppVersionValidationErrorBodyErrors) UnmarshalJSON(data []byte) (err error) {
	varStartUploadAppVersionValidationErrorBodyErrors := _StartUploadAppVersionValidationErrorBodyErrors{}

	err = json.Unmarshal(data, &varStartUploadAppVersionValidationErrorBodyErrors)

	if err != nil {
		return err
	}

	*o = StartUploadAppVersionValidationErrorBodyErrors(varStartUploadAppVersionValidationErrorBodyErrors)
