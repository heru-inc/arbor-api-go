...
type _AppsUpdateAppRequest AppsUpdateAppRequest
...
func (o *AppsUpdateAppRequest) UnmarshalJSON(data []byte) (err error) {
	varAppsUpdateAppRequest := _AppsUpdateAppRequest{}

	err = json.Unmarshal(data, &varAppsUpdateAppRequest)

	if err != nil {
		return err
	}

	*o = AppsUpdateAppRequest(varAppsUpdateAppRequest)
