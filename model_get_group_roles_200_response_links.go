...
// checks if the GetGroupRoles200ResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGroupRoles200ResponseLinks{}

// GetGroupRoles200ResponseLinks struct for GetGroupRoles200ResponseLinks
type GetGroupRoles200ResponseLinks struct {
...
type _GetGroupRoles200ResponseLinks GetGroupRoles200ResponseLinks
...
func NewGetGroupRoles200ResponseLinks() *GetGroupRoles200ResponseLinks {
	this := GetGroupRoles200ResponseLinks{}
	return &this
}
...
func (o *GetGroupRoles200ResponseLinks) SetPrevNil() {
	o.Prev.Set(nil)
}
...
func (o *GetGroupRoles200ResponseLinks) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o GetGroupRoles200ResponseLinks) MarshalJSON() ([]byte, error) {
...
func (o GetGroupRoles200ResponseLinks) ToMap() (map[string]interface{}, error) {
...
func (o *GetGroupRoles200ResponseLinks) UnmarshalJSON(data []byte) (err error) {
	varGetGroupRoles200ResponseLinks := _GetGroupRoles200ResponseLinks{}

	err = json.Unmarshal(data, &varGetGroupRoles200ResponseLinks)

	if err != nil {
		return err
	}

	*o = GetGroupRoles200ResponseLinks(varGetGroupRoles200ResponseLinks)
...
type NullableGetGroupRoles200ResponseLinks struct {
	value *GetGroupRoles200ResponseLinks
	isSet bool
}

func (v NullableGetGroupRoles200ResponseLinks) Get() *GetGroupRoles200ResponseLinks {
	return v.value
}

func (v *NullableGetGroupRoles200ResponseLinks) Set(val *GetGroupRoles200ResponseLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGroupRoles200ResponseLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGroupRoles200ResponseLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGroupRoles200ResponseLinks(val *GetGroupRoles200ResponseLinks) *NullableGetGroupRoles200ResponseLinks {
	return &NullableGetGroupRoles200ResponseLinks{value: val, isSet: true}
}

func (v NullableGetGroupRoles200ResponseLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGroupRoles200ResponseLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
