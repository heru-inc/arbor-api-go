...
// checks if the GetGroupRoles200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGroupRoles200ResponseMeta{}

// GetGroupRoles200ResponseMeta struct for GetGroupRoles200ResponseMeta
type GetGroupRoles200ResponseMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	From NullableInt32 `json:"from,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
	Links []GetGroupRoles200ResponseMetaLinksInner `json:"links,omitempty"`
...
type _GetGroupRoles200ResponseMeta GetGroupRoles200ResponseMeta
...
func NewGetGroupRoles200ResponseMeta() *GetGroupRoles200ResponseMeta {
	this := GetGroupRoles200ResponseMeta{}
	return &this
}
...
func (o *GetGroupRoles200ResponseMeta) SetFromNil() {
	o.From.Set(nil)
}
...
func (o *GetGroupRoles200ResponseMeta) GetLinks() []GetGroupRoles200ResponseMetaLinksInner {
	if o == nil || IsNil(o.Links) {
		var ret []GetGroupRoles200ResponseMetaLinksInner
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []GetGroupRoles200ResponseMetaLinksInner and assigns it to the Links field.
...
func (o *GetGroupRoles200ResponseMeta) SetToNil() {
	o.To.Set(nil)
}
...
func (o GetGroupRoles200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetGroupRoles200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
func (o *GetGroupRoles200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	varGetGroupRoles200ResponseMeta := _GetGroupRoles200ResponseMeta{}

	err = json.Unmarshal(data, &varGetGroupRoles200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetGroupRoles200ResponseMeta(varGetGroupRoles200ResponseMeta)
...
type NullableGetGroupRoles200ResponseMeta struct {
	value *GetGroupRoles200ResponseMeta
	isSet bool
}

func (v NullableGetGroupRoles200ResponseMeta) Get() *GetGroupRoles200ResponseMeta {
	return v.value
}

func (v *NullableGetGroupRoles200ResponseMeta) Set(val *GetGroupRoles200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGroupRoles200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGroupRoles200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGroupRoles200ResponseMeta(val *GetGroupRoles200ResponseMeta) *NullableGetGroupRoles200ResponseMeta {
	return &NullableGetGroupRoles200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetGroupRoles200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGroupRoles200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
